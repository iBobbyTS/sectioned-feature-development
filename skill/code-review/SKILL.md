...
- `DELEGATED_PASS`: parent provides a frozen packet; read [delegated-pass.md](references/delegated-pass.md). Supports `sfd-delegated-review/4.1` and legacy atomic `sfd-delegated-review/4.0`. This path overrides standalone loops/acceptance below.
